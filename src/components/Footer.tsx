...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="bg-hero text-primary-foreground">
      {/* Main Footer */}
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:0123456789" className="text-primary-foreground/70 hover:text-primary-foreground transition-colors">
                  01 23 45 67 89
                </a>
              </li>
              <li className="flex items-center gap-3">
